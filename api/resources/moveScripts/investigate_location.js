...
const process_encounter_choice = (newGameState, move, currentInvestigator) => {
  console.log("This is the active encounter we're submitting our choice to:", currentInvestigator.activeEncounter);
  console.log("This is the choice we're sending in to the encounter:", move);
  resolveEncounter(newGameState, currentInvestigator.activeEncounter, currentInvestigator, move);
  return newGameState;
}
